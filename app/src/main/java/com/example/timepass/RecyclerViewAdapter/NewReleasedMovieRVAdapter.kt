...
import com.example.timepass.Fragments.NewReleasedMovieFragmentDirections
import com.example.timepass.R

class NewReleasedMovieRVAdapter(val myMovies:List<MovieResult>):RecyclerView.Adapter<NewReleasedMovieRVAdapter.NewReleasedMovieRVViewHolder>() {
  ...
  class NewReleasedMovieRVViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewReleasedMovieRVViewHolder {
    return NewReleasedMovieRVViewHolder(
  ...
  override fun onBindViewHolder(holder: NewReleasedMovieRVViewHolder, position: Int) {
    ...
    // Navigation to the Details fragment from New released movies fragment and passing the details of the movie which is clicked to Details fragment
    holder.myCLForEachMovie.setOnClickListener {
      val action = NewReleasedMovieFragmentDirections.actionNewReleasedMovieFragmentToDetailsFragment(currentMovie)
